 ...
 * Generated at: 2018-06-19 01:51:44 UTC
...
public final class subscribe_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/jsp/weixin/../system/index/top.jsp", Long.valueOf(1524036862138L));
    _jspx_dependants.put("/WEB-INF/jsp/weixin/../system/index/foot.jsp", Long.valueOf(1504314938000L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://"
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<li class=\"text-warning green\"><i class=\"icon-star blue\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t在文本回复、图文回复、应用命令中\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<li class=\"text-warning green\"><i class=\"icon-star blue\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t添加一个关键词为\"关注\"的记录\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<li class=\"text-warning green\"><i class=\"icon-star blue\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t即为关注回复内容\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</li>\r\n");
