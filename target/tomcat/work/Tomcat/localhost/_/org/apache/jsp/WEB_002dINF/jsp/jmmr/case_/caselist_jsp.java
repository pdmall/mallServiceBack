 ...
 * Generated at: 2018-04-18 06:50:19 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.jsp.jmmr.case_;
...
public final class caselist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/jsp/jmmr/case/../../system/index/foot.jsp", Long.valueOf(1504314938000L));
    _jspx_dependants.put("/WEB-INF/jsp/jmmr/case/../../system/index/top.jsp", Long.valueOf(1519817186000L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort()
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<th class=\"center\">案例名称</th>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<td class='center' >{{ item.casename }}</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td class='center' >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<span v-if=\"item.type==0\">未审核</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<span v-if=\"item.type==1\">上级通过</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<span v-if=\"item.type==2\">上上级通过审核</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<span v-if=\"item.type==3\">上级未通过</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<span v-if=\"item.type==3\">上上级未通过，上级通过</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td class='center' >{{ item.created }}</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td class=\"center\">\r\n");
      ...
      out.write("\t\t\t                var url=\"");
      out.print(basePath);
      out.write("app/user/getusercaselist?page=\"+this.page;\r\n");
      out.write("\t\t\t    \t        \r\n");
      ...
      out.write("\t\t\t                });  \r\n");
      out.write("\t\t\t            \r\n");
      out.write("\t                var urlBanner=\"");
      out.print(basePath);
      out.write("banner/getBannerByPage\";\r\n");
      out.write("\t                \r\n");
      out.write("\t                this.$http.get(urlBanner).then(function(data){\r\n");
      out.write("\t                \t    var json = data.body;\r\n");
      out.write("\t\t                    this.banners=json.rows\r\n");
      out.write("\t       \t                },function(response){\r\n");
      out.write("\t       \t                    console.info(response);\r\n");
      out.write("\t       \t                });\r\n");
      out.write("\t               \r\n");
      ...
      out.write("\t\t        \t\t  var url=\"");
      out.print(basePath);
      out.write("app/user/getusercaselist?page=\"+this.page+\"&isPutaway=\"+this.selected+\"&pId=\"+pid+\"&shopId=\"+ids;\r\n");
      out.write("\t\t        \t  }else{\r\n");
      out.write("\t\t        \t\t  var url=\"");
      out.print(basePath);
      out.write("app/user/getusercaselist?page=\"+this.page+\"&isPutaway=\"+this.selected+\"&pId=\"+pid;\r\n");
      out.write("\t\t        \t  }\r\n");
      out.write("\t\t        \t \r\n");
      out.write("\t\t    \t        \r\n");
      out.write("\t\t                this.$http.get(url).then(function(data){\r\n");
      ...
      out.write("   \t\t\t\t\tvar url = \"");
      out.print(basePath);
      out.write("/app/user/deletecases\";\r\n");
      out.write("   \t\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\t\t\ttype: \"POST\",\r\n");
      out.write("\t\t\t\t\t\t\turl: url,\r\n");
