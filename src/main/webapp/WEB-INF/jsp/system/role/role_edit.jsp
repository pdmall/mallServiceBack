						...
						<input name="PARENT_ID" id="parent_id" value="${pd.parent_id }" type="hidden">
							...
							<table class="center" style="width:100%;">
								<tr style="text-align: center;">
									...
									<td><input type="text"  id="di" placeholder="这里输入折扣"  value="${pd.discount/1000}"  title="折扣" style="width:99%;"/></td>
									<td><input type="text"class='center hidden' name="discount" id="discount"   title="折扣" style="width:99%;"/></td>
								</tr>
								<tr>
