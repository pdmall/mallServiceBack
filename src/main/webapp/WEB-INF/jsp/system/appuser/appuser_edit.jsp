						...
						<form action="happuser/${msg }.do" name="userForm" id="userForm" method="post">
							...
							<table id="table_report" class="table table-striped table-bordered table-hover">
								...
								<tr>
									...
									<td style="width:79px;text-align: right;padding-top: 13px;">充值金额:</td>
									<td><input type="text" name="EMAIL" id="moeny"   maxlength="32" placeholder="这里输入充值金额" title="充值金额"  style="width:98%;" /></td>
								</tr>
								<tr>
