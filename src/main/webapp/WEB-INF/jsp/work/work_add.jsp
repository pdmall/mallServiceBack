												...
												<div id="zhongxin">
													...
													<table style="width: 100%;" id="xtable">
														...
														<tr id="users">
															<td style="padding-top: 10px;">工作室名称:<input
																type="text" name="workname" id="workname" value=""
													...
													placeholder="这里输入电话"  @blur="sousuo()"/> 
														...
														<tr>
													       ...
													       <span id="zq" style="display:none;" >
													                     负责人姓名:<span id="uname" style="margin-left:20px"></span>
													       </span>
														   </td>
														</tr>
														<tr>
	                                              ...
	                                              &nbsp;&nbsp;   经度:<span id="lng"></span>&nbsp;&nbsp;纬度:<span id="lat"></span></div>
	                                               <div id="searchResultPanel" style="border:1px solid #C0C0C0;width:150px;height:auto; display:none;"></div>
														...
														<tr>
															<td>
																...
																<textarea id="message" style="width:893px;height:159px;"></textarea>
															</td>
														</tr>
		...
		function save() {
   		console.log(buzhidao.imgUrl)
		    var workname=$("#workname").val();//工作室名称
   			...
   			var site=$("#suggestId").val();//地址
   			var lng=$("#lng").text();//经度
   			var lat=$("#lat").text();//纬度
   			var a=buzhidao.imgUrl;//图片
   			var photo=a.join(",");
