...
<body class="no-skin">
						...
						<div class="col-xs-12" id="pdtList">
							...
							<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top: 5px;">
								<thead>
									<tr>
										...
										<th class="center">工作室地址</th>
										<th class="center">工作室详情</th>
								...
								<tbody>
									...
									<tr v-for="item in items">
										...
										<td class='center' style="width: 130px;">{{ item.userName }}</td>
							...
							<div class="page-header position-relative">
								<table style="width: 100%;">
									<tr>
										<td style="vertical-align: top; width: 140px;"><a class="btn btn-mini btn-success" @click="add();">新增</a> <a class="btn btn-mini btn-danger" @click="makeAll('确定要删除选中的数据吗?');"
												title="批量删除">
	...
	//showPdtList();
		...
		var example2 = new Vue({
			  ...
			  created: function(){
				  var urls="<%=basePath%>work/getWorkList"
	         ...
	         methods:{
	            ...
	            edit:function(item){
	            	 localStorage.setItem("workid",item.id);
	            	 top.jzts();
	    			 var diag = new top.Dialog();
	    			 diag.Drag=true;
	    			 diag.Title ="编辑";
	    			 diag.URL = '<%=basePath%>page/work/work_edit';
	    			 diag.Width = 1050;
	    			 diag.Height = 805;
	    			 diag.Modal = true;				//有无遮罩窗口
	    			 diag. ShowMaxButton = true;	//最大化按钮
	            	 ...
	            	 add:function(item){
		    			 ...
		    			 diag.Drag=true;
		    			 diag.Title ="添加";
		    			 diag.URL = '<%=basePath%>page/work/work_add';
		    			 diag.Width = 1050;
		    			 diag.Height = 805;
		    			 diag.Modal = true;				//有无遮罩窗口
		    			 diag. ShowMaxButton = true;	//最大化按钮
