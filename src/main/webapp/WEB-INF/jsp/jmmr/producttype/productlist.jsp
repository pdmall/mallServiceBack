							...
							<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top: 5px;">
								...
								<tbody>
									...
									<tr v-for="item in items">
										...
										<td class='center' ><a @click="photo(item.sphotolist);" >图片</td>
	...
	//showPdtList();
		...
		var example2 = new Vue({
			  ...
			  created: function(){
			                ...
			                var url="<%=basePath%>app/user/getproductslist?page="+this.page;
	         ...
	         methods:{
	            ...
	            edit:function(item){
	            	 localStorage.setItem("productIds",item.id);
	            	 top.jzts();
	    			 var diag = new top.Dialog();
	    			 diag.Drag=true;
	    			 diag.Title ="编辑";
	    			 diag.URL = '<%=basePath%>page/jmmr/producttype/productupdated';
	    			 diag.Width = 800;
	    			 diag.Height = 755;
	    			 diag.Modal = true;				//有无遮罩窗口
	    			 diag. ShowMaxButton = true;	//最大化按钮
	            ...
	            delfff:function(ids) {
		          ...
		          changeType:function(pid){
		        	  ...
		        	  if(pid==0){
		        		  ...
		        		  var url="<%=basePath%>app/user/getproductslist?page="+this.page+"&isPutaway="+this.selected+"&pId="+pid+"&shopId="+ids;
		        	  }else{
		        		  var url="<%=basePath%>app/user/getproductslist?page="+this.page+"&isPutaway="+this.selected+"&pId="+pid;
		        	  }
		          ...
		          changeshopname:function(){
		           ...
		           makeAll:function(){
   					...
   					var url = "<%=basePath%>/app/user/deleteProductss";
   					$.ajax({
							type: "POST",
							url: url,
		...
		function add(){
			 ...
			 diag.Drag=true;
			 diag.Title ="新增";
			 diag.URL = '<%=basePath%>page/jmmr/producttype/productadd';
			 diag.Width = 800;
			 diag.Height = 755;
			 diag.Modal = true;				//有无遮罩窗口
			 diag. ShowMaxButton = true;	//最大化按钮
