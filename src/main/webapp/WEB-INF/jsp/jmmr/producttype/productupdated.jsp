...
<body>
										...
										<div class="widget-main">
											<div class="step-content row-fluid position-relative">
												<div id="zhongxin">
													...
													<div>
														产品名称：<input type="text"  id="name" :value=" pdt.productname " maxlength="50" placeholder="这里输入产品名称" title="产品名称"
																	style="width: 200px; margin-left: 5px; margin-right: 10px;" /> 
													</div>
													<div>简 介：</div>
													<div style="padding-left: 20px;">
														<textarea rows="5" cols="40" id="intro" :value="pdt.intro"></textarea>
													</div>
													
													<div style="padding-top:10px;">
														分享页面链接：<input type="text" :value="pdt.fenxiang" placeholder="这里输入分享页面链接" title="分享链接" id="fensite" style="width: 356px; margin-left: 5px; margin-right: 10px;">
													</div>
													<div style="padding-top:10px;">
														<div  style="float:left">
															...
															<div style="padding-top:5px;">
																<div  style="position:relative;display:inline-block">													
																			<img :src="aa+pdt.sphoto"  id="pdtImgMin" width="183" height="163" style="margin-left: 20px;">
														...
														<div style=" float:left;padding-left:100px;">
															...
															<video id="my_video_1" class="video-js vjs-default-skin" 
															    ...
															    <source id="videos" :src="aa+pdt.videosite" type="video/mp4">
															    <source id="videoss" :src="aa+pdt.videosite" type="video/webm">
															</video>
															</div>
														</div>
													</div><br>
													...
													<div style="padding-top:10px;">
													说明标题：<input type="text"  id="sname" :value=" pdt.headline " maxlength="50" placeholder="这里输入步骤标题" title="步骤标题"
																	style="width: 200px; margin-left: 5px; margin-right: 10px;" /> 
													</div>
													<div>步骤说明：</div>
													<div style="padding-top:10px;">
														<textarea rows="8" cols="50" id="buzhou" :value="pdt.step"></textarea>
													</div>
	...
	<script type="text/javascript">
	   ...
	   var id= localStorage.getItem("productIds");
	   ...
	   var pdtBanner= new Vue({  
	        ...
	        created:function(){
	        	...
	        	var url="<%=basePath%>app/user/getproductsByid?id="+id;
    	        
                this.$http.get(url).then(function(data){
                	this.pdt=data.body;
                    this.imgUrl1 = this.pdt.sphotolist.split(",");
                    this.imgUrl12 =  this.pdt.stuepphoto.split(",");
					this.imgUrl = this.pdt.sphoto;
                },function(response){
		...
		function save() {
			...
			$.ajax({
				url:'<%=path%>/app/user/updatedProducts',
				type : 'POST',
				data : {
				   id:id,
					productname:name,
