	...
	//showPdtList();
		...
		var example2 = new Vue({
			  ...
			  created: function(){
	                ...
	                var url="<%=basePath%>app/user/getguidephotolist?page="+this.page;
	         ...
	         methods:{
	        	 ...
	        	 <!--添加用户-->
	      		add:function(){
	    			 ...
	    			 diag.Drag=true;
	    			 diag.Title ="增加";
	    			 diag.URL = '<%=basePath%>page/jmmr/article/guidephotoadd';
	    			 diag.Width = 500;
	    			 diag.Height = 555;
	    			 diag.Modal = true;				//有无遮罩窗口
	    			 diag. ShowMaxButton = true;	//最大化按钮
	         	...
	         	<!--修改弹出-->
	            edit:function(item){
	            	 localStorage.setItem("guidephotoid",item.id);	            	 
	            	 localStorage.setItem("guidephoto",item.photo);	            	 
	            	 top.jzts();
	    			 var diag = new top.Dialog();
	    			 diag.Drag=true;
	    			 diag.Title ="编辑";
	    			 diag.URL = '<%=basePath%>page/jmmr/article/guidephotoupdated';
	    			 diag.Width = 600;
	    			 diag.Height = 655;
	    			 diag.Modal = true;				//有无遮罩窗口
	    			 diag. ShowMaxButton = true;	//最大化按钮
	            ...
	            delfff:function(ids) {
	            	bootbox.confirm("确定要删除吗?", function(result) {
	    				if(result) {
	    					top.jzts();
	    					var params={ids:ids}
	    					var url = "<%=basePath%>/app/user/deleteguidephoto";
	    					$.ajax({
								type: "POST",
								url: url,
						    	data: {ids:ids},
	              ...
	              btnClick: function(data){//页码点击事件
		               ...
		               var url="<%=basePath%>advertising/getguidephotolist?page="+this.cur;
		          ...
		          changeType:function(pid){
		        	  ...
		        	  var url="<%=basePath%>advertising/getguidephotolist?page="+this.selecteType;
