...
<body>
											...
											<div class="step-content row-fluid position-relative">
												<div id="zhongxin">
													...
													<table style="width: 100%;" id="xtable">
														...
														<tr>
															<td style="padding-top: 10px;">引导图展示:<input type="hidden"  id="xhItemImgMin"  maxlength="250" style="width: 300px; margin-left: 20px;" />
																<div class="btn btn-mini btn-primary"  style="margin-left: 15px;" onclick="toImgEdit();">上传引导图</div>
															</td>
														</tr>
	...
	<script type="text/javascript">
	   ...
	   var id= localStorage.getItem("guidephotoid");
	   var photo= localStorage.getItem("guidephoto");
	   ...
	   function toImgEdit() {
		...
		function save() {
			...
			$.ajax({
				url:'<%=path%>/app/user/updatedguidephoto',
				type : 'POST',
				data : {
				  id:id,
