...
<body>
													...
													<table style="width: 100%;" id="xtable">
														...
														<tr>
															<td style="padding-top: 10px;">
																	类型名称：<input type="text" :value="name" maxlength="32" id="titles" 
														...
														<tr>
															<td style="padding-top: 10px;">类型图展示:<input  type="hidden"  id="xhItemImgMin"  maxlength="250" style="width: 300px; margin-left: 20px;" />
																<div class="btn btn-mini btn-primary"  style="margin-left: 15px;" onclick="toImgEdit();">上传类型图</div>
															</td>
														</tr>
														
														<tr>
															<td style="padding-top: 10px;"><img :src="aa+photo" id="xhImgMin" width="200" height="200" style="margin-left: 200px; margin-top: -30px;"></td>
														</tr>
	...
	$(top.hangge());//关闭加载状态
	var id = localStorage.getItem("typephotoid");	            	 
	var name =  localStorage.getItem("typephotoname");	            	 
	var photo = localStorage.getItem("typephoto");	 
	   ...
	   function toImgEdit() {
		...
		function save() {
			...
			$.ajax({
				url:'<%=path%>/app/user/updatedtypephoto',
				type : 'POST',
				data : {
				  	id:id,
				   name : s,
