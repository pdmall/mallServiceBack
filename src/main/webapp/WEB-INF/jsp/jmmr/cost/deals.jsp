...
<body class="no-skin">
								...
								<div>
									<tbody>
										...
										<tr v-for="item in items">
											...
											<td class='center'>
												<span v-if="item.status==1">已转账</span>
												<span v-if="item.status==2">已确定转账</span>
	...
	//showPdtList();
		$(top.hangge());//关闭加载状态
		 ...
		 var s = localStorage.getItem("dealsphone");
		var example2 = new Vue({
			  ...
			  created: function(){
				    ...
				    this.ss = s;
	                var url="<%=basePath%>app/user/getdealslist?page="+this.page+"&phone="+this.ss;
	         ...
	         methods:{
	              ...
	              btnClick: function(data){//页码点击事件
		               ...
		               var url="<%=basePath%>app/user/getdealslist?page="+this.cur+"&phone="+this.ss;
		          ...
		          changeType:function(pid){
		        	  ...
		        	  var url="<%=basePath%>app/user/getdealslist?page="+this.selecteType+"&phone="+this.ss;
