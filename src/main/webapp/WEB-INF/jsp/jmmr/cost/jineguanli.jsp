...
<body>
												...
												<div id="zhongxin">
													<textarea name="CONTENT" id="CONTENT" style="display: none"></textarea>
														...
														<div  style="padding-top: 10px;">
																...
																<span>{{item[2].name}}:</span><input id="cost1" type="text" :value="item[2].cost" style="padding-left: 10px;"/>
															
															<a class="btn btn-mini btn-primary" onclick="save(1);">保存</a> <a class="btn btn-mini btn-danger" onclick="closes();">取消</a>
														</div>
														<div  style="padding-top: 10px;" class="hidden">
															
																<span>{{item[1].name}}:</span><input id="cost2" type="text" :value="item[1].cost/100" style="padding-left: 10px;"/>
															
															<a class="btn btn-mini btn-primary" onclick="save(2);">保存</a> <a class="btn btn-mini btn-danger" onclick="closes();">取消</a>
														</div>
	...
	<script type="text/javascript">
	   ...
	   var pdtBanner= new Vue({  
	        ...
	        created:function(){
	        	 var url="<%=basePath%>app/user/getjineguanli";
