...
<body>
													...
													<table style="width: 100%;" id="xtable">
														...
														<tr>
															<td style="padding-top: 10px;">
																...
																<select v-model="selectede" id="type1" class="" @change="changew( selectede )" style="width: 80px;" :vlaue="xhI.pid">
														...
														<tr>
															<td>
																...
																<select id="shijian" :value="xhI.type">
	...
	var idss = localStorage.getItem("plansIds");	 
	   ...
	   var pdtBanner= new Vue({  
	        ...
	        created:function(){
                ...
                //获取计划信息
                var url="<%=basePath%>app/user/getplanByid?id="+idss;
    	        
                this.$http.get(url).then(function(data){
                	this.xhI=data.body;
                  this.selectede=this.xhI.pid;
                  var s =[];
                s = this.xhI.time.split("-");
                  var s1 = s[0];
                this.hh = s1.split(":");
                var s2 = s[1];
                this.mm = s2.split(":");
                 
		                  var url="<%=basePath%>app/user/getintegraltype?id="+this.xhI.pid;
		      	        
		                  this.$http.get(url).then(function(data){
		                  	this.itemss=data.body;
		                  	this.sess=this.xhI.planid;
		                  },function(response){
		                      console.info(response);
		                  });  
