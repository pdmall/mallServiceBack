...
<body class="no-skin">
	...
	//showPdtList();
		...
		var phone = localStorage.getItem("order8phone");	
		var example2 = new Vue({
			  ...
			  created: function(){
	                ...
	                var url="<%=basePath%>app/user/getorder8list?page="+this.page+"&phone="+phone;
	         ...
	         methods:{
	         	...
	         	<!--修改弹出-->
	            edit:function(item){
	            	 localStorage.setItem("provinceid",item.id);	            	 
	            	 localStorage.setItem("provincecost",item.cost);	            	 
	            	 localStorage.setItem("provincepcost",item.pcost);	            	 
	            	 top.jzts();
	    			 var diag = new top.Dialog();
	    			 diag.Drag=true;
	    			 diag.Title ="编辑";
	    			 diag.URL = '<%=basePath%>page/jmmr/cost/costupdate';
	    			 diag.Width = 600;
	    			 diag.Height = 555;
	    			 diag.Modal = true;				//有无遮罩窗口
	    			 diag. ShowMaxButton = true;	//最大化按钮
	            ...
	            delfff:function(ids) {
	              ...
	              btnClick: function(data){//页码点击事件
		               ...
		               var url="<%=basePath%>app/user/getorder8list?page="+this.cur+"&phone="+phone;
		          ...
		          changeType:function(pid){
		        	  ...
		        	  var url="<%=basePath%>app/user/getorder8list?page="+this.selecteType;
