...
<body class="no-skin">
	...
	//showPdtList();
		...
		var phone = localStorage.getItem("consumephone");	
		var example2 = new Vue({
			  ...
			  created: function(){
	                ...
	                var url="<%=basePath%>app/user/getconsumelist?page="+this.page+"&phone="+phone;
	         ...
	         methods:{
	            ...
	            delfff:function(ids) {
	              ...
	              btnClick: function(data){//页码点击事件
		               ...
		               var url="<%=basePath%>app/user/getconsumelist?page="+this.cur+"&phone="+phone;
		          ...
		          changeType:function(pid){
		        	  ...
		        	  var url="<%=basePath%>app/user/getconsumelist?page="+this.selecteType;
