...
<body>
											...
											<div class="step-content row-fluid position-relative">
												<div id="zhongxin">
													...
													<div style="padding-left: 20px;">
														<textarea rows="5" cols="40" id="intro" :value="pdt.message"></textarea>
													</div>
													...
													<div style="padding-top:10px;">
														...
														<div style=" float:left;padding-left:100px;">
															...
															<video id="my_video_1" class="video-js vjs-default-skin" 
															    ...
															    <source id="videos"  type="video/mp4" :src="aa+pdt.video">
															    <source id="videoss"  type="video/webm" :src="aa+pdt.video">
															</video>
															</div>
														</div>
													</div>
	...
	<script type="text/javascript">
	   ...
	   var id= localStorage.getItem("ticklingids");
	   ...
	   var pdtBanner= new Vue({  
	        ...
	        created:function(){
	        	 ...
	        	 var urlBanner="<%=basePath%>app/user/getticklingByid?id="+id;
	                
	                this.$http.get(urlBanner).then(function(data){
	                	   this.pdt = data.body;
		                    this.imgUrl1=this.pdt.photo.split(",");
	       	                },function(response){
