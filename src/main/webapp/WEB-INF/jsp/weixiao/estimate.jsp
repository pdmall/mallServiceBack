...
<body class="no-skin">
								...
								<div>
									<tbody>
										...
										<tr v-for="item in items">
											...
											<td class='center' style="width: 230px;">{{	item.context }}</td>
	...
	//showPdtList();
		$(top.hangge());//关闭加载状态
		var aa =  localStorage.getItem("wxestimate");
		var example2 = new Vue({
			  ...
			  created: function(){
	                ...
	                var url="<%=basePath%>estimate/getestimates?id="+aa;
	            ...
	            delfff:function(ids) {
	            	bootbox.confirm("确定要删除吗?", function(result) {
	    				if(result) {
	    					top.jzts();
	    					var params={ids:ids}
	    					var url = "<%=basePath%>/estimate/deleteesimate";
	    					$.ajax({
								type: "POST",
								url: url,
						    	data: {id:ids},
