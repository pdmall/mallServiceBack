			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<input style="padding:10px 200px;background-color:rgb(0,162,232);display:block;color:white;" type="button" v-for="item in items" :value="item.yearmonth" @click="getbill(item.yearmonth)">
	...
	//showPdtList();
		...
		var example2 = new Vue({
			  ...
			  created: function(){
	                ...
	                var url="<%=basePath%>bill/getbillBystatus";
	         ...
	         methods:{
	        	 ...
	        	 getbill:function(photo){
	            	 ...
	            	 localStorage.setItem("billday",photo);
	            	 top.jzts();
	    			 var diag = new top.Dialog();
	    			 diag.Drag=true;
	    			 diag.Title ="查看";
	    			 diag.URL = '<%=basePath%>page/weixiao/bill';
	    			 diag.Width = 1025;
	    			 diag.Height = 985;
