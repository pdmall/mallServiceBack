								...
								<div>
									<tbody>
										...
										<tr v-for="item in items">
											...
											<td class='center'><a @click="photo(item.message)" >详情</a></td>
											<td class='center ' style="width: 200px;  ">{{ item.cost/100 }}</td>
											<td class='center ' style="width: 200px;  ">
												<span v-if="item.status==1">未售</span>
												<span v-else-if="item.status==2">已售</span>
	...
	//showPdtList();
		...
		var example2 = new Vue({
			  ...
			  created: function(){
	                ...
	                var url="<%=basePath%>used/getusedlist?page="+this.page;
	            ...
	            delfff:function(ids) {
	            	bootbox.confirm("确定要删除吗?", function(result) {
	    				if(result) {
	    					top.jzts();
	    					var params={ids:ids}
	    					var url = "<%=basePath%>/used/deleteuseds";
	    					$.ajax({
								type: "POST",
								url: url,
						    	data: {id:ids},
	              ...
	              btnClick: function(data){//页码点击事件
		               ...
		               var url="<%=basePath%>used/getusedlist?page="+this.cur;
		          ...
		          changeType:function(pid){
		        	  ...
		        	  var url="<%=basePath%>used/getusedlist?page="+this.selecteType;
