												...
												<div id="zhongxin">
													...
													<table style="width: 100%;" id="xtable">
														...
														<div class="input-group input-group-lg">
															...
															<input type="text" class="form-control " placeholder="请输入娱乐类型名称" id="type" />
														</div>
														<br />
														<div class="input-group input-group-lg">
															<span class="input-group-addon">地&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;址:</span>
															<input type="text" class="form-control " placeholder="请输入店铺地址" id="site" />
														</div>
														<br />
														<div class="input-group input-group-lg">
															<span class="input-group-addon">优&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;惠:</span>
															<input type="text" class="form-control " placeholder="请输入优惠内容" id="gilt" />
														</div>
														<br />
														<div class="input-group input-group-lg">
															<span class="input-group-addon">简&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;介:</span>
															<input type="text" class="form-control " placeholder="请输入简介内容" id="intro" />
														</div>
														<br />
														<div class="input-group input-group-lg">
															<span class="input-group-addon">开放时间:</span>
															<input type="text" class="form-control " placeholder="如：周五-周六" id="time" />
														</div>
														<br />
														<div class="input-group input-group-lg">
															<span class="input-group-addon">联系方式:</span>
															<input type="text" class="form-control " placeholder="如：13565656565" id="uphone" />
														</div>
														<br />
	...
	<script type="text/javascript">
	   ...
	   function toImgEdits() {
		...
		function save() {
			...
			$.ajax({
				url:'<%=path%>/recrea/postrecreation',
				type : 'POST',
				data : {
					type: type,
					site : site,
