												...
												<div id="zhongxin">
													...
													<table style="width: 100%;" id="xtable">
														...
														<div class="input-group input-group-lg">
															...
															<input type="text" class="form-control " placeholder="如：英语一级轻松过" id="title" />
														</div><br />
														<div class="input-group input-group-lg">
															<span class="input-group-addon">类&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别:</span>
															<input type="text" class="form-control " placeholder="如：英语一级" id="type" />
														</div>
														<br />
														<div class="input-group input-group-lg">
															<span class="input-group-addon">开课时间:</span>
															<input type="text" class="form-control " placeholder="如：12月12日" id="time" />
														</div>
														<br />
													
														<div class="input-group input-group-lg">
															<span class="input-group-addon">课&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;时:</span>
															<input type="text" class="form-control " placeholder="如：20课时" id="hour" />
														</div>
														<br />
														<div class="input-group input-group-lg">
															<span class="input-group-addon">人&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;数:</span>
															<input type="text" class="form-control " placeholder="如：20人" id="number" />
														</div><br />
														<div class="input-group input-group-lg">
															<span class="input-group-addon">价&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;格:</span>
															<input type="text" class="form-control " placeholder="如：300" id="cost" />
														</div><br />
														<div class="input-group input-group-lg">
															<span class="input-group-addon">课程介绍:</span>
															<textarea id="intro" style="width:443px;height:159px;"></textarea>
														</div>
														<br />
														<div class="input-group input-group-lg">
															<span class="input-group-addon">课程老师:</span>
															<textarea id="teacher" style="width:443px;height:159px;"></textarea>
														</div>
														<br />
														<div class="input-group input-group-lg">
															<span class="input-group-addon">老师介绍:</span>
															<textarea id="teacherintro" style="width:443px;height:159px;"></textarea>
														</div>
														<br />
