								...
								<div>
									<tbody>
										...
										<tr v-for="item in items">
											...
											<td class='center'><a @click="photo(item.zphoto)" >图片</a></td>
											<td class='center'><a @click="photo(item.fphoto)" >图片</a></td>
											<td class='center'><a @click="photo(item.xphoto)" >图片</a></td>
	...
	//showPdtList();
		...
		var example2 = new Vue({
			  ...
			  created: function(){
	                ...
	                var url="<%=basePath%>expert/getexpertlists?page="+this.page;
	         ...
	         methods:{
	        	 ...
	        	 <!--添加用户-->
	      		add:function(){
	    			 ...
	    			 diag.Drag=true;
	    			 diag.Title ="增加";
	    			 diag.URL = '/page/weixiao/expertadd';
	    			 diag.Width = 800;
	    			 diag.Height = 755;
	    			 diag.Modal = true;				//有无遮罩窗口
	    			 diag. ShowMaxButton = true;	//最大化按钮
	            ...
	            delfff:function(ids) {
	            	bootbox.confirm("确定要删除吗?", function(result) {
	    				if(result) {
	    					top.jzts();
	    					var params={ids:ids}
	    					var url = "<%=basePath%>/expert/deleteexpert";
	    					$.ajax({
								type: "POST",
								url: url,
						    	data: {id:ids},
	              ...
	              btnClick: function(data){//页码点击事件
		               ...
		               var url="<%=basePath%>expert/getexpertlists?page="+this.cur;
		          ...
		          changeType:function(pid){
		        	  ...
		        	  var url="<%=basePath%>expert/getexpertlists?page="+this.selecteType;
