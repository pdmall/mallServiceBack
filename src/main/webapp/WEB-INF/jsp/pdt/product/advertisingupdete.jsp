...
<body>
													...
													<table style="width: 100%;" id="xtable">
														...
														<tr>
															<td style="padding-top: 10px;">
																	链接地址：<input type="text"  maxlength="32" id="titles" :value="types.companyname"
														...
														<tr>
															<td style="padding-top: 10px;margin-left: 15px;">广告图展示:<input type="hidden"  id="xhItemImgMin"  maxlength="20" style="width: 300px; margin-left: 0px;" /><br/>
																<div class="btn btn-mini btn-primary"  style="margin-top:10px" onclick="toImgEdit();">上传广告图</div>
															</td>
														</tr>
														
														<tr>
															<td style="padding-top: 10px;"><img :src="aa+types.photo" id="xhImgMin" width="200" height="200" style="margin-left: 200px; margin-top: -30px;"></td>
														</tr>
														
														
														<tr>
															<td style="text-align: center;" colspan="10"><a class="btn btn-mini btn-primary" @click="save(types);">保存</a> <a class="btn btn-mini btn-danger" onclick="top.Dialog.close();">取消</a></td>
														</tr>
													</table>
												</div>
	...
	<script type="text/javascript">
	   ...
	   var ids= localStorage.getItem("zjaid");
	   var pdtBanner= new Vue({  
	        ...
	        created:function(){
	        	 var url="<%=basePath%>advertising/getadvertisingById?id="+ids;
