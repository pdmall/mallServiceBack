									...
									<tr>
										<td style="vertical-align: top; width: 140px;"><a
											class="btn btn-xs btn-success" title="增加" @click="add(  )">
												增加 </a> <a class="btn btn-mini btn-danger"
	...
	//showPdtList();
		...
		var example2 = new Vue({
			  ...
			  created: function(){
	                ...
	                var url="<%=basePath%>advertising/getadvertisingPage?page="+this.page;
	         ...
	         methods:{
	            ...
	            delfff:function(ids) {
	              ...
	              btnClick: function(data){//页码点击事件
		               ...
		               var url="<%=basePath%>advertising/getadvertisingPage?page="+this.cur;
		          ...
		          changeType:function(pid){
		        	  ...
		        	  var url="<%=basePath%>advertising/getadvertisingPage?page="+this.selecteType;
