				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
								...
								<a title="发送短信" class="btn btn-mini btn-warning center-block" onclick="postMsg('确定要给用户发送短信吗?',15983129344);" style="width:150px;font-size:22px;padding:20px;margin-left:200px;"><i class="ace-icon fa fa-envelope-o bigger-120"></i>发送短信</a>
						</div>
						<!-- /.col -->
					</div>
					<!-- /.row -->
