											...
											<div class="step-content row-fluid position-relative">
												<div id="zhongxin">
													...
													<table style="width: 100%;" id="xtable">
														<tr>
															<td style="padding-top: 10px;">店铺名称:<input type="text" id="shopTitle" maxlength="50" placeholder="这里输入项目名称" title="店铺名称"
																	style="width: 200px; margin-left: 20px; margin-right: 10px;" /> 
															用户姓名:<input type="text"  name="shopLinkname" id="shopLinkname" maxlength="32"
																	placeholder="联系人姓名" title="联系人姓名" style="width: 160px; margin-left: 10px;" /><label style="margin-left:10px;"> 
																	用户手机号:</label><input type="text"  id="shopPhone"
														...
														<tr>
															...
															区：
															<select id="district"  class="chosen-select" style="vertical-align: top; width: 100px;">
												...
												<i class="ace-icon fa fa-globe"></i>
															...
															详细地址:<input type="text" id="shopAddress" maxlength="50" style="width:400px;margin-left:20px;" placeholder="这里输入店铺地址" title="这里输入店铺地址" />
