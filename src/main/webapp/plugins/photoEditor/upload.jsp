...
if ( contentType.indexOf("multipart/form-data") >= 0 )
{
	...
	while( fileItems.hasNext() )
	{
		...
		{
			String virtualPath = "uploadFiles/uploadImgs/jsp_avatar" + avatarNumber + "_" + fileName + ".jpg";
			...
			if( isSourcePic )
			{
				...
				result.sourceUrl = virtualPath = String.format("uploadFiles/uploadImgs/jsp_source_%s.%s", fileName, sourceExtendName);
			}
			...
			String virtualPath = "uploadFiles/uploadImgs/pdt_min_img" + avatarNumber + "_" + fileName + ".jpg";
			...
			String virtualPath = "uploadFiles/uploadImgs/xh_item_post" + avatarNumber + "_" + fileName + ".jpg";
